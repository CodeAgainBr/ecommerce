...
class PedidosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pedido" do
    assert_difference('Pedido.count') do
      post pedidos_url, params: { pedido: { status: @pedido.status, titulo: @pedido.titulo, user_id: @pedido.user_id } }
    end
  ...
  test "should update pedido" do
    patch pedido_url(@pedido), params: { pedido: { status: @pedido.status, titulo: @pedido.titulo, user_id: @pedido.user_id } }
